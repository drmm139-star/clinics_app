...
class MainHospitalsScreen extends StatelessWidget {
  const MainHospitalsScreen({super.key});
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) => const SubHospitalScreen(
                            hospitalName: 'المركز الطبي التخصصي',
                          ),
                        ),
                      );
                    },
                  ...
                  ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (_) => const SubHospitalScreen(
                            hospitalName: 'مركز التأهيل لذوي الاحتياجات',
                          ),
                        ),
                      );
                    },
